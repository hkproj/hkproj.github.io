...
- [ML Interpretability: feature visualization, adversarial example, interp. for language models](https://www.youtube.com/watch?v=lg1-M8hEX50)
...
- [Distributed Data Parallel (DDP) with PyTorch: complete tutorial with cloud infrastructure and code](https://www.youtube.com/watch?v=toUSzwR0EV8)
...
- [CLIP - Paper explanation (training and inference)](https://www.youtube.com/watch?v=L3BTG8ETY_Y)
